...
## 1. 什么时候才需要引入 redux ？
  ...
  ![redux-pipeline](https://github.com/wulucxy/blog/raw/master/src/routes/posts/2018-05-17-redux-best-practice/image/redux-pipeline.png)
...
## 4. redux 数据结构
  ...
  **什么时候使用 Redux store，什么时候使用 React state？**
  ...
  ![redux_state](https://github.com/wulucxy/blog/raw/master/src/routes/posts/2018-05-17-redux-best-practice/image/redux_state.png)
